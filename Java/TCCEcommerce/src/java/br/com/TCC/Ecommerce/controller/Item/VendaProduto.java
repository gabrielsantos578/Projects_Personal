 ...
 * @author Aluno03
 */
@WebServlet(name = "VendaProduto", urlPatterns = {"/VendaProduto"})
public class VendaProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GenericDAO daoV = new ItemDAOImpl();
            request.setAttribute("vendas", daoV.vendaProduto(condition));
            
        } catch (Exception ex) {
            System.out.println("Problemas ao consultar os Produtos mais Vendidos! Erro: " + ex);
